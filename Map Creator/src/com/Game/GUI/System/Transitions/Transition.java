package com.Game.GUI.System.Transitions;
...
public class Transition {
    ...
    public void paintTransition(Graphics g) {
        if (active) {
            ...
            int textAlignment;
            textAlignment = methods.getNewHorizontalTextAlignment(g, title, Enums.alignmentHorizontal.MIDDLE, Fonts.font.TITLE);
            int titleOffset = 0;
            ...
            for (int i = 0; i < subtitles.length; i += 1) {
                if (!subtitles[i].equals("")) {
                    textAlignment = methods.getNewHorizontalTextAlignment(g, subtitles[i], Enums.alignmentHorizontal.MIDDLE, Fonts.font.SUBTITLE);
